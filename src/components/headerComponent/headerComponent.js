    ...
    render() {
      ...
      <button class="nav-burger">
        <svg width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6 11.75C5.58579 11.75 5.25 12.0858 5.25 12.5C5.25 12.9142 5.58579 13.25 6 13.25V11.75ZM18 13.25C18.4142 13.25 18.75 12.9142 18.75 12.5C18.75 12.0858 18.4142 11.75 18 11.75V13.25ZM6 15.75C5.58579 15.75 5.25 16.0858 5.25 16.5C5.25 16.9142 5.58579 17.25 6 17.25V15.75ZM18 17.25C18.4142 17.25 18.75 16.9142 18.75 16.5C18.75 16.0858 18.4142 15.75 18 15.75V17.25ZM6 7.75C5.58579 7.75 5.25 8.08579 5.25 8.5C5.25 8.91421 5.58579 9.25 6 9.25V7.75ZM18 9.25C18.4142 9.25 18.75 8.91421 18.75 8.5C18.75 8.08579 18.4142 7.75 18 7.75V9.25ZM6 13.25H18V11.75H6V13.25ZM6 17.25H18V15.75H6V17.25ZM6 9.25H18V7.75H6V9.25Z" fill="white"/>
          </svg>
      </button>

      <figure id="logo">
        <img src="https://static.pullandbear.net/2/static2/img/headLogo/logo_pull_white.svg" alt="" />
      </figure>
      <nav class="hidden" id="main-nav">
        <div class="options-menu">
          <ul>
            <li><a class="nav-item" href="./index.html">NEW</a></li >
            <li><a class="nav-item" href="./sales.html">SALES</a></li >
            <li class="nav-item">SHOES</li>
            <li class="nav-item">UNISEX</li>
            <li class="nav-item">ACCESORIES</li>
          </ul>
        </div>
      </nav>
      ...
      <li class="nav-item">
        <svg width="18" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M15.4766 16.8516L18.5793 20.0692" stroke="#FAFBFA" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" />
        </svg>
      </li>

      <li class="nav-item">
        <a class="nav-item" href="./register.html"><svg width="17" height="22" viewBox="0 0 17 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd"
